  ...
  render() {
    ...
    let grid = (
      <Grid
        ...
        title={this.props.view.toUpperCase()}
        elems={this.state[view]}
      />
    );
    return (
      <div className="render-screen">
        <div
          className="button"
          onClick={this.props.updateView.bind(this, "panels")}
        >
          Back
        </div>
        <div className="render-content">
          <div className="render-title text">
            <h3>{this.props.view.toUpperCase()}</h3>
          </div>
